...
export const AFFIRMATIONS = [
  "Я залишаюсь спокійним джерелом підтримки для тих, хто цього потребує.\n— афірмація психолога",
  "Моя присутність і увага вже є частиною зцілення.\n— афірмація психолога",
  "Я приймаю себе таким, яким я є, і дозволяю собі бути недосконалим.\n— афірмація психолога",
  "Я слухаю не лише слова, а й тишу між ними.\n— афірмація психолога",
  "Сьогодні я обираю співчуття замість осуду — до інших і до себе.\n— афірмація психолога",
  "Я маю право на втому. Турбота про себе — основа моєї роботи.\n— афірмація психолога",
  "Кожна розмова має значення, навіть якщо результати не видно одразу.\n— афірмація психолога",
  "Я довіряю своєму професійному досвіду й продовжую вчитися.\n— афірмація психолога",
  "Чужі емоції — не моя ноша. Я можу бути поруч, не розчиняючись у них.\n— афірмація психолога",
